      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-6">
        <div className="flex-1">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-semibold text-neutral-800">Internship Progress</h2>
        ...
        <div className="sm:w-48 shrink-0 pt-1 sm:pt-0 sm:border-l sm:border-neutral-100 sm:pl-6">
          ...
          <div className="flex gap-4 mt-3 text-center">
            {[
              { l: 'Present', v: stats?.attendedDays || 0, c: 'text-emerald-600' },
              { l: 'Late', v: stats?.lateDays || 0, c: 'text-warning-600' },
              { l: 'Excused', v: stats?.izinDays || 0, c: 'text-primary-600' },
              { l: 'Absent', v: stats?.alphaDays || 0, c: 'text-red-500' },
            ].map((x) => (
              <div key={x.l}>
